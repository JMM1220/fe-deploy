...
function download (repo, dest, opts, fn) {
  ...
  if (clone) {
    ...
    console.log(cloneOptions, 'cloneOptions', url, dest)
    gitclone('https://github.com/JMM1220/fe-deploy-template.git', dest, cloneOptions, function (err) {
      if (err === undefined) {
        rm(dest + '/.git')
        fn()
      } else {
    ...
    downloadUrl('https://github.com/JMM1220/fe-deploy-template.git', dest, downloadOptions)
      .then(function (data) {
        fn()
      })
      .catch(function (err) {
...
function normalize (repo) {
  ...
  if (match) {
    ...
    console.log(url, directCheckout)
